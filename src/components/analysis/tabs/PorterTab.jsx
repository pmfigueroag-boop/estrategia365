...
import PorterForces from '@/components/analysis/PorterForces';

const PorterRadar = dynamic(() => import('@/components/charts/PorterRadar'), { ssr: false });
const PorterHeatMap = dynamic(() => import('@/components/charts/PorterHeatMap'), { ssr: false });
const PorterExecutiveSummary = dynamic(() => import('@/components/charts/PorterExecutiveSummary'), { ssr: false });
const PorterAttractivenessMatrix = dynamic(() => import('@/components/charts/PorterAttractivenessMatrix'), { ssr: false });
const PorterPressureMap = dynamic(() => import('@/components/charts/PorterPressureMap'), { ssr: false });
const PorterConfidenceOverlay = dynamic(() => import('@/components/charts/PorterConfidenceOverlay'), { ssr: false });
const PorterStrategyBridge = dynamic(() => import('@/components/charts/PorterStrategyBridge'), { ssr: false });
const PorterForceNetwork = dynamic(() => import('@/components/charts/PorterForceNetwork'), { ssr: false });
const PorterBattlefield = dynamic(() => import('@/components/charts/PorterBattlefield'), { ssr: false });
const PorterIndustryDNA = dynamic(() => import('@/components/charts/PorterIndustryDNA'), { ssr: false });
const PorterMonteCarlo = dynamic(() => import('@/components/charts/PorterMonteCarlo'), { ssr: false });
const PorterOnePager = dynamic(() => import('@/components/charts/PorterOnePager'), { ssr: false });
const PorterTimeline = dynamic(() => import('@/components/charts/PorterTimeline'), { ssr: false });
const PorterBlueOceanOverlay = dynamic(() => import('@/components/charts/PorterBlueOceanOverlay'), { ssr: false });
const PorterWarRoom = dynamic(() => import('@/components/charts/PorterWarRoom'), { ssr: false });
const PorterBscBridge = dynamic(() => import('@/components/charts/PorterBscBridge'), { ssr: false });
const PorterIntelligenceCockpit = dynamic(() => import('@/components/charts/PorterIntelligenceCockpit'), { ssr: false });
